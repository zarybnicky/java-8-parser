...
\begin{frame}{Stavový diagram lexeru}
  \includegraphics[width=0.1\textwidth]{img/lex1.pdf}
% \begin{center}
% \begin{tikzpicture}
%    [>=stealth',
%    punktchain/.style={
...
\end{itemize}
%Dakujem za pozornost sa do prezentacie nedava to sa iba povie
\end{frame}

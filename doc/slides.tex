...
{Martin~Vaško, Michal~Vaško, Jakub~Zárybnický, Jiří~Záleský, Marek~Tamaškovič}
...
\begin{frame}
  \titlepage
  \note[item]{Varianta a/4/I - Knuth–Morris–Pratt(KMP) algoritmus pre vyhledáni podřetezce v řetezci, jako seřaďovací algoritmus byl použit List-Merge a tabulka symbolu byla implementovaná pomoci BVS (Binárního vyhledavácího stromu).}
\end{frame}
